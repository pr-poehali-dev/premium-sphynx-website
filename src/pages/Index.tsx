...
function Index() {
  ...
  const kittens: Kitten[] = [
    ...
    },
    {
      ...
      color: 'Розовый',
      price: '95 000 ₽',
      image: 'https://cdn.poehali.dev/projects/20a04798-865f-48e1-9edb-4a0b9194bd6b/files/9601f09b-010d-4ee9-9611-8a0cf0ca4d36.jpg',
      available: true,
    ...
    },
    {
      ...
      color: 'Серебристый',
      price: '75 000 ₽',
      image: 'https://cdn.poehali.dev/projects/20a04798-865f-48e1-9edb-4a0b9194bd6b/files/778c3556-064c-49de-8696-37b60b4f7f79.jpg',
      available: true,
      description: 'Энергичный малыш с любопытным характером. Очень игривый и активный. Отлично ладит с детьми и другими животными.',
      parents: 'Мать: Ch. Луна Селена / Отец: GrCh. Зевс Импириал',
      vaccinations: ['Первая комплексная вакцинация', 'Обработка от паразитов'],
      documents: ['Родословная WCF', 'Ветеринарный паспорт', 'Договор купли-продажи', 'Гарантия здоровья']
    },
    {
      id: 6,
      ...
      color: 'Кремово-серый',
      price: '88 000 ₽',
      image: 'https://cdn.poehali.dev/projects/20a04798-865f-48e1-9edb-4a0b9194bd6b/files/7d0bcfe2-4cbc-4265-b06d-ccd1548f5e19.jpg',
      available: true,
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in">
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Более 3 лет мы разводим канадских сфинксов чемпионских линий и редких окрасов. 
